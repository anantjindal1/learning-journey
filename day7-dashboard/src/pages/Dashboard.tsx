...
const Dashboard: FC = () => {
  ...
  // We keep the top-level dashboard layout focused on content sections so that
  // the surrounding shell (navbar, page background) can be shared across routes.
      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        <div className="bg-gray-800/90 rounded-xl p-6 md:p-8 flex flex-col shadow-lg shadow-black/40 border border-gray-700/60 backdrop-blur">
          ...
          <p className="text-xs md:text-sm text-gray-400 mb-3">
            Jot down anything on your mind. Notes auto‑save as you type and stay
            on this device.
          </p>
...
// (hover, focus, target) in one place and keep the page readable.
